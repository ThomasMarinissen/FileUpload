<?php
namespace Th\FileUploader\Exceptions;
    ...
    private function codeToMessage($code) {
        ...
        switch ($code) {
            ...
            case UPLOAD_ERR_EXTENSION:
                ...
                break;
            case \Th\FileUploader\FileUploader::FILE_WRONG_MIME:
                $message = "File is of the wrong MIME type";
                break;
            case \Th\FileUploader\FileUploader::FILE_WRONG_EXTENSION:
                $message = "File is of the wrong extension";
                break;
            case \Th\FileUploader\FileUploader::NO_FILES_UPLOADED:
                $message = "No files were uploaded";
                break;
            case \Th\FileUploader\FileUploader::INVALID_UPLOAD_DIR:
                $message = "User set upload directory does not exist";
                break;
            case \Th\FileUploader\FileUploader::CAN_NOT_MOVE_FILE:
