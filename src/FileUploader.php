<?php
namespace Th\FileUploader;
use \Th\FileUploader\Exceptions\UploadException;
...
class FileUploader {
    ...
    /**
     * Constructor method of the FileUploader class.
     * 
     ...
     * @return  \Th\FileUploader\FileUploader              The instance of this, to make chaining possible
    ...
    public function setUploadFile($fieldName) {
        ...
        if (count($_FILES) == 0 || !isset($_FILES[$fieldName])) {
            throw new UploadException(\Th\FileUploader\FileUploader::NO_FILES_UPLOADED);
        }
    ...
    public function setUploadDir($dir) {
        ...
        if (!is_dir($dir)) {
            throw new UploadException(\Th\FileUploader\FileUploader::INVALID_UPLOAD_DIR);
    ...
    public function validateFileType() {
        ...
        if (!is_array($this->allowedTypes()) || !in_array($this->type(), $this->allowedTypes())) {
            throw new UploadException(\Th\FileUploader\FileUploader::FILE_WRONG_MIME);
        }
    ...
    public function upload() {
        ...
        if (!move_uploaded_file($this->tmpName(), $this->uploadFilePath())) {
            ...
            throw new UploadException(CAN_NOT_MOVE_FILE);
        } 
